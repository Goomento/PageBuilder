 ...
 */
abstract class Element extends ControlsStack
{
     ...
     *
     * @return Element|false Child element instance, or false if failed.
     */
     ...
     *
     * @return Element Current instance of the element.
     */
    ...
    public function printElement()
    {
         ...
         *
         *
         * @param Element $this The element.
         */
        Hooks::doAction('pagebuilder/frontend/before_render', $this);
         ...
         * @param Element $this The element.
         */
        Hooks::doAction("pagebuilder/frontend/{$element_type}/before_render", $this);
         ...
         * @param Element $this The element.
         */
        $should_render = Hooks::applyFilters("pagebuilder/frontend/{$element_type}/should_render", $should_render, $this);
         ...
         * @param Element $this The element.
         */
        Hooks::doAction("pagebuilder/frontend/{$element_type}/after_render", $this);
         ...
         * @param Element $this The element.
         */
        Hooks::doAction('pagebuilder/frontend/after_render', $this);
    }
    ...
    protected function _addRenderAttributes()
    {
         ...
         * @param Element $this The element.
         */
        Hooks::doAction('pagebuilder/element/after_add_attributes', $this);
    }
     ...
     *
     * @return Element|false Child type or false if type not found.
     */
    private function getChildType($element_data)
    {
         ...
         *
         *
         * @param Element $child_type   The child element.
         * @param array        $element_data The original element ID.
         * @param Element $this         The original element.
         */
        return Hooks::applyFilters('pagebuilder/element/get_child_type', $child_type, $element_data, $this);
    }
