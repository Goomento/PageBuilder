		...
		<div class="gmt-control-field">
			...
			<div class="gmt-control-input-wrapper">
				<div class="gmt-choices">
					...
					<input id="<?= $control_uid; ?>" type="radio" name="gmt-choose-{{ data.name }}-{{ data._cid }}" value="{{ value }}">
					<label class="gmt-choices-label tooltip-target" for="<?= $control_uid; ?>" data-tooltip="{{ options.title }}" title="{{ options.title }}">
