...
class Image extends AbstractWidget
{
    ...
    {
        ?>
		<# if ( settings.image_image.url ) {

			var image_url = settings.image_image.url;
            var image_size = settings.image_image_size === 'custom' ? settings.image_image_custom_dimension : {},
			...
			var hasCaption = function() {
				if( ! settings.image_caption_source || 'none' === settings.image_caption_source ) {
					return false;
				}
				return true;
			}
			...
			var getCaption = function() {
				...
				return 'custom' === settings.image_caption_source ? settings.image_caption : '';
			}

			var link_url;

			if ( 'custom' === settings.image_link_to ) {
				link_url = settings.image_link.url;
			}

			if ( 'file' === settings.image_link_to ) {
				link_url = settings.image_image.url;
			}

			#><div class="gmt-image{{ settings.image_shape ? ' gmt-image-shape-' + settings.image_shape : '' }}"><#
			var imgClass = '';

			if ( '' !== settings.image_hover_animation ) {
				imgClass = 'gmt-animation-' + settings.image_hover_animation;
			}
			...
			if ( link_url ) {
					#><a class="gmt-clickable" data-gmt-open-lightbox="{{ settings.image_open_lightbox }}" href="{{ link_url }}"><#
			}
						#><img
