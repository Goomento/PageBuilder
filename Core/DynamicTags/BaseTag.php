 ...
 */
abstract class BaseTag extends ControlsStack
{
    ...
    {
        StaticObjectManager::get(Controls::class)->openStack($this);
        ...
        if (1 === count(StaticObjectManager::get(Controls::class)->getStacks($this->getUniqueName())['controls'])) {
            StaticObjectManager::get(Controls::class)->openStack($this);
        }
