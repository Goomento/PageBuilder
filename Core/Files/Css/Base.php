...
use Goomento\PageBuilder\Core\DynamicTags\Tag;
use Goomento\PageBuilder\Core\Files\Base as BaseFile;
 ...
 */
abstract class Base extends BaseFile
{
    ...
    {
        return 'external'  === StaticData::getCssPrintMethod();
    }
    ...
    public function enqueue()
    {
         ...
         */
        Hooks::doAction("pagebuilder/css-file/{$name}/enqueue", $this);
    }
    ...
    public function printCss()
    {
        ...
        StaticObjectManager::get(Frontend::class)->printFontsLinks();
    }
    ...
    public function parsePropertyPlaceholder(array $control, $value, array $controls_stack, $value_callback, $placeholder, $parser_control_name = null)
    {
        ...
        $control_obj = StaticObjectManager::get(Controls::class)->getControl($control['type']);
     ...
     *
     *
     * @param \Goomento\PageBuilder\Builder\Base\ControlsStack $controls_stack The controls stack.
     ...
     */
    public function addControlsStackStyleRules(\Goomento\PageBuilder\Builder\Base\ControlsStack $controls_stack, array $controls, array $values, array $placeholders, array $replacements, array $all_controls = null)
    {
        if (! $all_controls) {
    ...
    {
        $isAdmin = StaticUtils::isAdminhtml();
        if ($isAdmin) {
            return true;
        }
    ...
    private function initStylesheet()
    {
        ...
        $this->stylesheet_obj = StaticObjectManager::get(Stylesheet::class);
     ...
     *
     *
     * @param \Goomento\PageBuilder\Builder\Base\ControlsStack $controls_stack The control stack.
     * @param array $repeater_control The repeater control.
     * @param array $repeater_values Repeater values array.
     * @param array $placeholders Placeholders.
     * @param array $replacements Replacements.
     */
    protected function addRepeaterControlStyleRules(\Goomento\PageBuilder\Builder\Base\ControlsStack $controls_stack, array $repeater_control, array $repeater_values, array $placeholders, array $replacements)
    {
