...
class IconList extends Widget
{
    ...
    protected function registerControls()
    {
        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .gmt-icon-list-text' => StaticData::isRtl() ? 'padding-right: {{SIZE}}{{UNIT}};' : 'padding-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->addRenderAttribute('icon_list', 'class', 'gmt-icon-list-items');
        $this->addRenderAttribute('list_item', 'class', 'gmt-icon-list-item');

        if ('inline' === $settings['view']) {
            $this->addRenderAttribute('icon_list', 'class', 'gmt-inline-items');
            $this->addRenderAttribute('list_item', 'class', 'gmt-inline-item');
        } ?>
        <ul <?= $this->getRenderAttributeString('icon_list'); ?>>
            ...
            foreach ($settings['icon_list'] as $index => $item) :
                ...
                $this->addRenderAttribute($repeater_setting_key, 'class', 'gmt-icon-list-text');
